...
def main():
            ...
            for algoritmo_info in algoritmos:
                ...
                for _ in range(num_repeticoes):
                    ...
                    if nome_algoritmo == "BubbleSort":
                        ...
                        A = vetor  # Defina 'A' como o vetor que você deseja classificar
                        B = [0] * len(A)  # Crie uma lista B do mesmo tamanho que A para armazenar os valores ordenados
                        k = max(vetor)
                        CountingSort.counting_sort(A, B, k)
                    elif nome_algoritmo == "HeapSort":
                        HeapSort.build_max_heap(vetor)  # Chame o método estático build_max_heap diretamente na classe
                ...
                #print(f"Vetor Desordenado: {resultados[chave]['Vetor Desordenado']}")
                #print(f"Vetor Ordenado: {resultados[chave]['Vetor Ordenado']}")
                #print(f"Tempos de Execução: {resultados[chave]['Tempos de Execucao']}")
    ...
    # Plotar gráficos para média, mediana e desvio padrão
